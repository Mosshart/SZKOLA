...
public class OnButtonClickEvent : MonoBehaviour
{
    ...
    public void checkIsCorrect()
    {
        ...
        {
            parent.GetComponent<QuestionGenerator>().pCounter[0].GetComponent<Canvas>().GetComponent<PointsCounter>().points += 1;
            //parent.GetComponent<QuestionGenerator>().PointsEarned = 1;
        }
